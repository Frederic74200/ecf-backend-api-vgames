 ...
 */
final class Version20240229092116 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE gizmondo (id INT AUTO_INCREMENT NOT NULL, publisher_id INT NOT NULL, game VARCHAR(50) NOT NULL, year INT NOT NULL, dev VARCHAR(70) NOT NULL, INDEX IDX_97A931B340C86FCE (publisher_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
